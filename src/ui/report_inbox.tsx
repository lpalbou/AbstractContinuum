  ...
  return (
    <div className="page page_pad">
      <div className="page_toolbar">
        <div className="seg seg_scroll" role="group" aria-label="Inbox views">
          {triage_enabled ? (
            <>
              <button aria-pressed={tab === "messages"} className={`seg_btn ${tab === "messages" ? "active" : ""}`} onClick={() => set_tab("messages")}>
                Messages
              </button>
              <button aria-pressed={tab === "email"} className={`seg_btn ${tab === "email" ? "active" : ""}`} onClick={() => set_tab("email")}>
                Email
              </button>
              <button aria-pressed={tab === "bugs"} className={`seg_btn ${tab === "bugs" ? "active" : ""}`} onClick={() => set_tab("bugs")}>
                Bugs
              </button>
              <button aria-pressed={tab === "features"} className={`seg_btn ${tab === "features" ? "active" : ""}`} onClick={() => set_tab("features")}>
                Features
              </button>
            </>
          ) : (
        ...
        {triage_enabled && tab !== "email" && triage_last ? <span className="page_hint mono">{triage_last}</span> : null}
        {triage_enabled && tab !== "email" && error ? <span className="page_error mono">{error}</span> : null}
            ...
            {tab === "messages" ? (
                ...
                <div className="inbox_detail">
                  ...
                  {selected_decision_draft ? (
                    <div className="inbox_markdown">
                      ...
                      <Markdown className="md_doc" text={String(selected_decision_draft.content || "")} />
                    </div>
                  ) : null}
                  ...
                  <div className="inbox_markdown">
                    ...
                    {selected_decision_report_md ? (
                      <Markdown className="md_doc" text={selected_decision_report_md} />
                    ) : (
                      <div className="mono muted" style={{ fontSize: "var(--font-size-sm)" }}>
              ...
              <div className="inbox_detail">
                ...
                {selected_report_loading ? (
                  ...
                  <Markdown className="md_doc" text={selected_report_md} />
                ) : (
                  <div className="mono muted" style={{ fontSize: "var(--font-size-sm)" }}>
                    No content loaded.
                  </div>
